package com.example.runfit.services
...
import com.example.runfit.other.Constants.ACTION_SHOW_TRACKING_FRAGMENT
...
import com.example.runfit.other.Constants.FASTEST_LOCATION_INTERVAL
import com.example.runfit.other.Constants.LOCATION_UPDATE_INTERVAL
import com.example.runfit.other.Constants.NOTIFICATION_CHANNEL_ID
import com.example.runfit.other.Constants.NOTIFICATION_CHANNEL_NAME
import com.example.runfit.other.Constants.NOTIFICATION_ID
        ...
        timeRunInSec.observe(this,Observer{
            if(!isServiceKilled){
                val notification = curNoticationBuilder
                    .setContentText(TrackingUtility.getFormattedTimeInStopwatch(it * 1000L))
